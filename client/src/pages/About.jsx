...
import DashChart from '../components/Chart.jsx'
...
<div className='flex mt-10 h-auto justify-center'>
<form action="https://api.web3forms.com/submit" method="POST" className="flex flex-col gap-10 bg-gray-200 h-auto dark:border-gray-700 dark:bg-gray-800 p-10 " style={{width:"800px"}}>
...
<div className='w-full'>
        <div className="mb-2 block">
          <Label htmlFor="email2" value="City Name" />
        </div>
            <TextInput
            type='text'
            placeholder='City'
            ...
            <div className='w-full'>
        <div className="mb-2 block">
          <Label htmlFor="email2" value="PinCode" />
        </div>
            <TextInput
            type='number'
...
<section class="bg-white dark:bg-gray-900">
  <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
      <div class="max-w-screen-md mb-8 lg:mb-16">
          <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">About City Service</h2>
          <p class="text-gray-500 sm:text-xl dark:text-gray-400">Welcome to City Service, your go-to platform for connecting with trusted service professionals in your area. Whether you're in need of a plumber, electrician, beautician, or any other service provider, we've got you covered.</p>
      </div>
      <div class="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
          <div>

              <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-blue-500 lg:h-12 lg:w-12 dark:bg-blue-900 hover:shadow-lg transition duration-300">
    <svg class="w-5 h-5 text-white lg:w-6 lg:h-6 dark:text-primary-300" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
        <path fill-rule="evenodd" d="M3 3a1 1 0 000 2v8a2 2 0 002 2h2.586l-1.293 1.293a1 1 0 101.414 1.414L10 15.414l2.293 2.293a1 1 0 001.414-1.414L12.414 15H15a2 2 0 002-2V5a1 1 0 100-2H3zm11.707 4.707a1 1 0 00-1.414-1.414L10 9.586 8.707 8.293a1 1 0 00-1.414 0l-2 2a1 1 0 101.414 1.414L8 10.414l1.293 1.293a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path>
              ...
              <p class="text-gray-500 dark:text-gray-400">At City Service, our mission is simple: to make your life easier by connecting you with reliable service professionals who can meet your needs.  </p>
          </div>
          <div>
              <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-blue-500 lg:h-12 lg:w-12 dark:bg-blue-900 hover:shadow-lg transition duration-300">
          ...
          <div>
              ...
              <p class="text-gray-500 dark:text-gray-400">City Service was founded with a simple vision: to revolutionize the way people access and experience services in their communities.</p>
          </div> 
          <div>
              <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-blue-500 lg:h-12 lg:w-12 dark:bg-blue-900 hover:shadow-lg transition duration-300">
              ...
              <p class="text-gray-500 dark:text-gray-400">We understand the importance of financial well-being. We've partnered with experienced financial advisors to provide you with expert guidance.</p>
          </div>
          <div>
              <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-blue-500 lg:h-12 lg:w-12 dark:bg-blue-900 hover:shadow-lg transition duration-300">
          ...
          <div>
              ...
              <p class="text-gray-500 dark:text-gray-400">Join the City Service community today and discover the difference for yourself. We invite you to be part of our growing network.</p>
          </div>
      </div>
  </div>
</section>
<section class="bg-white dark:bg-gray-900">
  <div class="max-w-screen-xl px-4 py-8 mx-auto text-center lg:py-16 lg:px-6">
    <dl class="grid max-w-screen-md gap-8 mx-auto text-gray-900 sm:grid-cols-3 dark:text-white">
      <div class="flex flex-col items-center justify-center transform transition-all hover:scale-105">
